...
const cechStyles = `
  <style>
    /* ===== CECH / CAPACITACIÓN PAGE SCOPED STYLES ===== */
    .cech-page { font-family: 'Source Sans 3', Arial, sans-serif; }
    .cech-section { max-width: 1400px; margin: 0 auto; padding: 0 15px; }
    ...
    .cech-banner-text h2 { font-size: 18px; color: #fff; font-weight: 400; margin: 0; }
    .cech-banner-text h2.gold { color: goldenrod; }
    .cech-banner-logo img { width: 160px; }
    ...
    .cech-title span { font-weight: 400; }

    /* Asociaciones */
    .cech-asociaciones { padding: 60px 0; }
    .cech-asociaciones-grid {
      display: flex; flex-wrap: wrap; gap: 40px; align-items: center;
    }
    .cech-asoc-text { flex: 1 1 450px; }
    .cech-asoc-text p { font-size: 15px; line-height: 1.7; color: #555; }
    .cech-asoc-text p strong { color: #333; }
    .cech-asoc-logos {
      flex: 1 1 300px;
      display: flex; align-items: center; justify-content: flex-end; gap: 20px;
    }
    .cech-asoc-logos img { height: 80px; }
    .cech-asoc-logos .cech-separator {
      width: 1px; height: 80px; background: #ccc;
    }

    /* Formación (image left, text right) */
    .cech-formacion { padding: 0; }
    .cech-formacion-grid {
      display: flex; flex-wrap: wrap; align-items: stretch;
    }
    .cech-formacion-img { flex: 1 1 50%; }
    .cech-formacion-img img { width: 100%; height: 100%; object-fit: cover; display: block; }
    .cech-formacion-content { flex: 1 1 50%; padding: 50px 40px; }
    .cech-formacion-content p { font-size: 14px; color: #777; line-height: 1.7; margin-bottom: 25px; }

    .cech-features-grid {
      display: grid; grid-template-columns: 1fr 1fr; gap: 25px;
    }
    .cech-feature { display: flex; gap: 12px; }
    .cech-feature-icon { width: 30px; height: 30px; flex-shrink: 0; margin-top: 3px; }
    .cech-feature-icon img { width: 100%; height: 100%; object-fit: contain; }
    .cech-feature h5 { font-size: 15px; font-weight: 700; color: #333; margin-bottom: 6px; }
    .cech-feature ul { padding-left: 18px; margin: 0; }
    .cech-feature li { font-size: 13px; color: #777; line-height: 1.6; }
    .cech-feature p { font-size: 13px; color: #777; margin: 0; }

    /* Certificaciones */
    .cech-certificaciones { padding: 60px 0; }
    .cech-cert-grid {
      display: flex; flex-wrap: wrap; gap: 60px; justify-content: center;
      margin-top: 30px;
    }
    .cech-cert-card { flex: 1 1 350px; max-width: 500px; }
    .cech-cert-card h3 {
      font-size: 22px; font-weight: 700; color: #1a2936;
      text-align: center; margin-bottom: 15px;
    }
    .cech-cert-card p, .cech-cert-card li {
      font-size: 14px; color: #555; line-height: 1.7;
    }
    .cech-cert-card ul { padding-left: 20px; }
    .cech-cert-card a.cech-read-more {
      color: #555; font-size: 14px; text-decoration: none;
      cursor: pointer;
    }
    .cech-cert-card a.cech-read-more:hover { text-decoration: underline; }
    .cech-cert-card .cech-hidden-text { display: none; }
    .cech-cert-card .cech-hidden-text.cech-expanded { display: block; }
    ...
    .cech-training::before {
      content: '';
      position: absolute; top:0; left:0; right:0; bottom:0;
      background: rgba(0,0,0,0.65);
      z-index: 0;
    }
    .cech-training .cech-section { position: relative; z-index: 1; }
    .cech-training-grid {
      display: flex; flex-wrap: wrap; align-items: center; gap: 40px;
    }
    .cech-training-text { flex: 1 1 300px; }
    .cech-training-text h2 {
      font-size: 28px; font-weight: 400; color: #fff;
      border-left: 3px solid goldenrod; padding-left: 15px; margin-bottom: 15px;
    }
    .cech-training-text h2 b { font-weight: 700; }
    .cech-training-text p { font-size: 14px; color: #ddd; line-height: 1.7; }

    .cech-training-features { flex: 1 1 500px; }
    .cech-training-feat-grid {
      display: grid; grid-template-columns: 1fr 1fr; gap: 25px;
    }
    .cech-train-feat { display: flex; gap: 12px; }
    .cech-train-feat-icon { width: 40px; height: 40px; flex-shrink: 0; }
    .cech-train-feat-icon img { width: 100%; }
    .cech-train-feat h5 {
      font-size: 14px; font-weight: 700; color: #fff; text-transform: uppercase; margin-bottom: 5px;
    }
    .cech-train-feat p { font-size: 13px; color: #ccc; margin: 0; line-height: 1.6; }

    /* Cursos */
    .cech-cursos { padding: 60px 0; }
    .cech-cursos-grid {
      display: flex; flex-wrap: wrap; gap: 30px; margin-top: 30px;
    }
    .cech-curso-card { flex: 1 1 300px; }
    .cech-curso-card img { width: 100%; border-radius: 4px; margin-bottom: 15px; }
    .cech-curso-card h4 {
      font-size: 14px; font-weight: 700; color: #1a2936;
      text-transform: uppercase; margin-bottom: 10px;
    }
    .cech-curso-card p { font-size: 13px; color: #555; line-height: 1.7; }
    .cech-curso-card p b { color: #333; }

    /* Contacto form */
    .cech-contacto { padding: 60px 0; background: #f8f8f8; }
    .cech-contacto .cech-title { margin-bottom: 30px; }
    .cech-form-grid { display: flex; flex-wrap: wrap; gap: 30px; }
    .cech-form-left { flex: 1 1 350px; }
    .cech-form-right { flex: 1 1 350px; }
    .cech-form-group { margin-bottom: 20px; }
    .cech-form-group label {
      font-size: 12px; text-transform: uppercase; color: #999;
      letter-spacing: 1px; display: block; margin-bottom: 6px;
    }
    .cech-form-group input, .cech-form-group textarea {
      width: 100%; border: none; border-bottom: 1px solid #ccc;
      background: transparent; padding: 8px 0;
      font-size: 14px; color: #333; outline: none;
      font-family: 'Source Sans 3', Arial, sans-serif;
    }
    .cech-form-group textarea { resize: vertical; min-height: 180px; }
    .cech-form-submit {
      text-align: right; margin-top: 15px;
    }
    .cech-form-submit button {
      background: #1a2936; color: #fff; border: none;
      padding: 10px 30px; font-size: 14px; font-weight: 600;
      text-transform: uppercase; letter-spacing: 1px; cursor: pointer;
      transition: background 0.3s;
    }
    .cech-form-submit button:hover { background: #333; }

    @media (max-width: 991px) {
      .cech-formacion-grid { flex-direction: column; }
      .cech-features-grid { grid-template-columns: 1fr; }
      .cech-training-feat-grid { grid-template-columns: 1fr; }
    }
    @media (max-width: 575px) {
      .cech-banner-text h1 { font-size: 26px; }
    }
  </style>`;

const cechContent = `
  <!-- .......... MAIN .......... -->
  <main class="page-content cech-page">

    <!-- BANNER -->
    <section class="cech-banner">
      <div class="cech-section">
        <div class="cech-banner-text">
          <h1>CAPACITACIÓN HYTORC</h1>
          <h2>NO TE LIMITES A CAPACITARTE,</h2>
          <h2 class="gold">¡CAPACÍTATE EN EL CECH!</h2>
        </div>
      </div>
    </section>

    <!-- ASOCIACIONES PERFECTAS -->
    <section class="cech-asociaciones">
      <div class="cech-section">
        <div class="cech-asociaciones-grid">
          <div class="cech-asoc-text">
            <h2 class="cech-title">ASOCIACIONES <span>PERFECTAS</span></h2>
    ...
    <section class="cech-formacion">
      <div class="cech-formacion-grid">
        <div class="cech-formacion-img">
          <img src="assets/Captura de pantalla 2026-03-04 114134.png" alt="Formación HYTORC">
        </div>
        <div class="cech-formacion-content">
          <h2 class="cech-title">¿POR QUÉ FORMACIÓN HYTORC?</h2>
          <p>En el Centro de Evaluación y Certificación HYTORC (CECH), nuestro objetivo es elevar la seguridad de sus requisitos operativos y de mantenimiento, mejorando los principios y prácticas de empernado industrial y ayudándolo a mejorar sus habilidades en el manejo de herramientas para satisfacer sus necesidades de mantenimiento.</p>
          <div class="cech-features-grid">
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/Captura de pantalla 2026-03-04 182217.png" alt=""></div>
              <div>
                <h5>¡Ahorra dinero!</h5>
                <ul>
            ...
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/Captura de pantalla 2026-03-04 182112.png" alt=""></div>
              <div>
            ...
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/Captura de pantalla 2026-03-04 182129.png" alt=""></div>
              <div>
            ...
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/Captura de pantalla 2026-03-04 182200.png" alt=""></div>
              <div>
            ...
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/m.png" alt=""></div>
              <div>
            ...
            <div class="cech-feature">
              <div class="cech-feature-icon"><img src="assets/Captura de pantalla 2026-03-04 182155.png" alt=""></div>
              <div>
    ...
    <!-- LAS CERTIFICACIONES -->
    <section class="cech-certificaciones">
      <div class="cech-section">
        <h2 class="cech-title">LAS CERTIFICACIONES</h2>
        <div class="cech-cert-grid">
          <div class="cech-cert-card">
            <h3>¿POR QUÉ ASME?</h3>
            ...
            <div class="cech-hidden-text" id="asme-extra">
              <ul>
            ...
            <a href="#" class="cech-read-more" onclick="event.preventDefault(); var el=document.getElementById('asme-extra'); el.classList.toggle('cech-expanded'); this.textContent=el.classList.contains('cech-expanded')?'Leer menos':'Leer más';">Leer más</a>
          </div>
          <div class="cech-cert-card">
            <h3>¿POR QUÉ ANCE?</h3>
            ...
            <div class="cech-hidden-text" id="ance-extra">
              <ul>
            ...
            <a href="#" class="cech-read-more" onclick="event.preventDefault(); var el=document.getElementById('ance-extra'); el.classList.toggle('cech-expanded'); this.textContent=el.classList.contains('cech-expanded')?'Leer menos':'Leer más';">Leer más</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="cech-training">
      <div class="cech-section">
        <div class="cech-training-grid">
          <div class="cech-training-text">
            <h2>Entrenar es fácil<br><b>con HYTORC</b></h2>
            <p>Capacite a su equipo en nuestro Centro de capacitación y Certificación HYTORC (CECH) para lograr la excelencia en empernado.</p>
          </div>
          <div class="cech-training-features">
            <div class="cech-training-feat-grid">
              <div class="cech-train-feat">
                <div class="cech-train-feat-icon"><img src="assets/Captura de pantalla 2026-03-04 182045.png" alt=""></div>
                <div>
              ...
              <div class="cech-train-feat">
                <div class="cech-train-feat-icon"><img src="assets/Captura de pantalla 2026-03-04 182143.png" alt=""></div>
                <div>
              ...
              <div class="cech-train-feat">
                <div class="cech-train-feat-icon"><img src="assets/Captura de pantalla 2026-03-04 182212.png" alt=""></div>
                <div>
              ...
              <div class="cech-train-feat">
                <div class="cech-train-feat-icon"><img src="assets/Captura de pantalla 2026-03-04 182138.png" alt=""></div>
                <div>
                  <h5>LLEGAMOS A TI</h5>
    ...
    <section class="cech-cursos">
      <div class="cech-section">
        <h2 class="cech-title"><strong>CURSOS DE FORMACIÓN</strong> <span>MÁS POPULARES</span></h2>
        <div class="cech-cursos-grid">
          <div class="cech-curso-card">
    ...
    <section class="cech-contacto">
      <div class="cech-section">
        <h2 class="cech-title"><strong>CONTÁCTENOS</strong> <span>PARA CAPACITACIÓN</span></h2>
        <form id="form_capacitacion_co">
          <div class="cech-form-grid">
            <div class="cech-form-left">
              <div class="cech-form-group">
                <label>Nombre</label>
...
<head>
  ...
  <title>Capacitación CECH | HYTORC Colombia</title>
  <meta name="description"
    content="Capacitación CECH de HYTORC. Centro de Evaluación y Certificación HYTORC. Cursos de formación certificados por ASME." />
  <meta name="robots" content="index, follow" />
  <link rel="canonical" href="https://www.hytorc.com.co/capacitacion-cech.html" />
...
fs.writeFileSync(path.join(dir, 'capacitacion-cech.html'), finalHTML, 'utf8');
console.log('Successfully built capacitacion-cech.html');
