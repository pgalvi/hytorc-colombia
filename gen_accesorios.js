...
const mxHtml = fs.readFileSync('mx_accesorios.html', 'utf8');
...
headContent = headContent.replace('<title>Inicio | HYTORC Colombia</title>', '<title>Accesorios | HYTORC Colombia</title>');
...
bannerContent = bannerContent.replace('<section class="banner-accesorios">', '<section class="banner-accesorios" style="background: url(assets/dim-background-black.png) center/cover fixed; padding: 120px 0;">');
...
fs.writeFileSync('productos_accesorios.html', headContent + '\\n' + mainContent, 'utf8');
console.log('Created productos_accesorios.html');
