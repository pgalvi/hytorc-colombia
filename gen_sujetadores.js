...
const mxHtml = fs.readFileSync('mx_sujetadores.html', 'utf8');
...
headContent = headContent.replace('<title>Inicio | HYTORC Colombia</title>', '<title>Sujetadores | HYTORC Colombia</title>');
...
bannerContent = bannerContent.replace('<h1>SUJETADORES</h1>', '<h1>SUJETADORES INDUSTRIALES Y ARANDELAS</h1>');
...
// Replace all product images with empty grey placeholders
...
fs.writeFileSync('productos_sujetadores.html', headContent + '\\n' + mainContent, 'utf8');
console.log('Created productos_sujetadores.html');
