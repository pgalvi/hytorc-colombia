...
const mxHtml = fs.readFileSync('mx_tensionadores_bombas.html', 'utf8');
...
headContent = headContent.replace('<title>Inicio | HYTORC Colombia</title>', '<title>Tensionadores y Bombas | HYTORC Colombia</title>');
...
bannerContent = bannerContent.replace('<section class="banner-tensionadores">', '<section class="banner-tensionadores" style="background: url(assets/dim-background-black.png) center/cover fixed; padding: 120px 0;">');
...
console.log('Created productos_tensionadores_bombas.html');
