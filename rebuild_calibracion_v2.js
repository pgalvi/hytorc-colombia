...
<main class="page-content cal-page">
 ...
 <div class="cal-ruta-text">
  <h2 class="tit-LineRedLeft">OTROS SERVICIOS DE CALIBRACION (ofertados solo por trazabilidad o en convenio)</h2>
  <p>
  Prestamos otros servicios de calibracion fuera del alcance acreditado, estos servicios de calibración se llevan a cabo de acuerdo con métodos y procedimientos internos basados en normas nacionales e internacionales.
  <br><br>
 ...
 <h5 class="tit-LineRedLeft">MAGNITUD: PAR TORSIONAL (TORQUIMETROS MANUALES)</h5>
 <ul>
 <li>Torquímetros manuales. (Ofertado solo por Trazabilidad Metrológica).</li>
 <li>Medición de multiplicadores de torque (Ofertado solo por Trazabilidad Metrológica)</li>
 </ul>
 </div>
 <div class="cal-serv-col">
